...
# Sentinel-2 bands needed for soil index calculation
SENTINEL2_BANDS_NEEDED = ['red', 'nir']  # Red (B4) and NIR (B8)

# Date range for Sentinel-2 imagery (dry season for Amazon)
...
def main():
    ...
    soil_index_path = features.calculate_soil_index(
        band04_path=downloaded_bands['red'],
        band08_path=downloaded_bands['nir'],
